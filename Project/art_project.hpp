	...
	namespace project {
		...
		public:
			explicit ArtProject(ArtProjectDummy) :
				runPath("."),
				projectName("ArtPDE"),
				projectGeometryFolderName("Geometry"),
				projectSettingFolderName("Setting"),
				projectInitialFolderName("Initial"),
				projectResultsFolderName("Results"),
				slash("\\"){};
		...
		private:
			...
			std::string projectGeometryFolderName;
			std::string projectSettingFolderName;
			std::string projectInitialFolderName;
			std::string projectResultsFolderName;
#if defined( _MSC_VER )
			std::string slash;
#else
			std::string slash{ '/' };
